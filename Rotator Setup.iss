...
;
[Setup]
AppID={{77B823AF-A7AC-403F-AAF4-BF1ADF16A3B6}
AppName=ASCOM Stroblhofwarte Helical Focuser Driver
AppVerName=ASCOM Stroblhofwarte Helical Focuser Driver 1.1.1
AppVersion=1.1.1
...
OutputDir="."
OutputBaseFilename="HelicalFocuser Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Focuser\StroblhofwarteHelicalFocuser"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Focuser\StroblhofwarteHelicalFocuser"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "C:\_develop\ASCOM.Stroblhofwarte.Helical.Focuser\ASCOM.Stroblhofwarte.Helical.Focuser\bin\Release\ASCOM.Stroblhofwarte.Helical.Focuser.Focuser.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "C:\_develop\ASCOM.Stroblhofwarte.Helical.Focuser\ASCOM.Stroblhofwarte.Helical.Focuser\README.htm"; DestDir: "{app}"; Flags: isreadme
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.Stroblhofwarte.Helical.Focuser.Focuser.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.Stroblhofwarte.Helical.Focuser.Focuser.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.Stroblhofwarte.Helical.Focuser.Focuser.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.Stroblhofwarte.Helical.Focuser.Focuser.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.Stroblhofwarte.Helical.Focuser.Focuser.dll"""; Flags: runhidden 64bit; Check: IsWin64
